...
public:
    ...
    [[nodiscard]] bool read_cell() const;
    void set_cell(int pos,bool value);
    [[nodiscard]] bool get_cell(int pos) const;
...
public:
    ...
    Command &at(int i);
    [[nodiscard]] const Command& at(int i)const;
...
public:
    ...
    [[nodiscard]] int get_pos() const {return head_pos;}
    [[nodiscard]] int get_program_index() const {return program_index;}
